...
if (getQueryVariable('link')) {
    ...
    $('#text').html('');
    scalar = 1;
    $('form').replaceWith('<form action="http://your-cool-web-app.azurewebsites.net/"><input type="submit" id="redirect" value="Wanna make another?"> <input type="button" id="twitter" value="Share on twitter">');
